  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-16 bg-neutral-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-center text-neutral-900 mb-12">Advanced Service Components</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <Card className="bg-white border-2 border-accent">
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-semibold text-neutral-900 mb-3">Free Strategic Consultation</h3>
                <p className="text-neutral-600 mb-4">
                  Comprehensive 60-minute strategic consultation to assess your business needs and create a custom growth plan tailored to your goals.
                </p>
                <ul className="text-sm text-neutral-500 space-y-1">
      ...
      <section id="free-consultation" className="py-20 bg-primary">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
            Start with a Free 60-Minute Strategic Consultation
          </h2>
          <p className="text-xl text-primary-foreground/90 mb-8">
            Discover how our Launch & Growth Accelerator can transform your business strategy and accelerate your path to success. 
            Get personalized recommendations with no commitment required.
          </p>
